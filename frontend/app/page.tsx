    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-6 py-4 text-2xl border-2 rounded-lg focus:ring-4 focus:ring-blue-500 focus:border-blue-500 ${
        ...
        <div className="mt-8 text-center text-gray-600">
          <p className="text-lg">
            💡 Tip: Click the 🔊 icon next to any question to hear it read aloud
          </p>
          <p className="text-lg mt-2">
            ⌨️ Use Tab to navigate between fields and Enter to submit
          </p>
        </div>
      </div>
    </div>
